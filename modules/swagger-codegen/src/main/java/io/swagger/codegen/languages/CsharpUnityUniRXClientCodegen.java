...
public class CsharpUnityUniRXClientCodegen extends AbstractCSharpCodegen {
    public static final String CLIENT_PACKAGE = "clientPackage";
    protected String clientPackage = "IO.Swagger.Client";
    protected String apiDocPath = "docs/";
    protected String modelDocPath = "docs/";

    public CsharpUnityUniRXClientCodegen() {
        super();
        ...
        setSourceFolder("src" + File.separator + "main" + File.separator + "CsharpUnityUniRXClientCodegen");
    ...
    public String getName() {
        return "csharp-unity-unirx";
    }

    @Override
    public String getHelp() {
        return "Generates a C# Unity UNIRX client library.";
    }
